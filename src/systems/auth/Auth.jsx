        ...
        try {
            ...
            if (Res.statusCode === 200) {
                Swal.fire({
                    ...
                    text: "Chào mừng bạn đến với UNETI",
    ...
    return (
        <div className="h-[100vh] bg-[#fafafa]">
            <div className="container mx-auto xl:max-w-[1280px] bg-[#fafafa]">
                <Row>
                    <Col span={12}>
                        <div className="mt-[15vh] mx-auto w-[60%]">
                            <p className="text-2xl  font-medium text-center">
                                Chào mừng bạn đến với UNETI
                            </p>
                            <p className="text-lg my-[20px] text-center">
                                Đại học Kinh Tế - Kĩ Thuật Công Nghiệp
                            </p>
                            <img
                                className="h-[40vh] w-[40vh] object-cover mx-auto"
                                src={logo}
                                alt="Hình ảnh"
                            />
                        </div>
                                ...
                                <div className="">
                                    <div className="mb-6 my-5">
                                        ...
                                        <input
                                            ...
                                            placeholder="ngongocvanDHTI15A10HN@gmail.com"
                                            required
                                            onChange={(e) =>
